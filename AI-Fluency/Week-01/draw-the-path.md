...
![Claude Project Configuration](./images/configured-claude-project.png)

## 3. Pressure Test Prompt
![Pressure Test Prompt](./images/pressure-test-prompt.png)

## 4. Claude Pressure Test Feedback
![Claude Pressure Test Feedback](./images/pressure-test-prompt-output1.png)
![Claude Pressure Test Feedback](./images/pressure-test-prompt-output2.png)
![Claude Pressure Test Feedback](./images/pressure-test-prompt-output3.png)
![Claude Pressure Test Feedback](./images/pressure-test-prompt-output4.png)
